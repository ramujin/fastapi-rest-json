...
# Storing the "database" in memory for simplicity, but this should be a real database
@asynccontextmanager
async def lifespan(app: FastAPI):
  ...
  try:
    ...
    store.user_store.save()


# Configuration
app = FastAPI(lifespan=lifespan)  # Specify the "app" that will run the routing
